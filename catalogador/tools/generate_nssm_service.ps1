...
Usage (Admin):
    .\generate_nssm_service.ps1 -ServiceName 'Catalogador-PythonAPI' -PythonExe 'C:\ProgramData\Catalogador\python_api\venv\Scripts\python.exe' -AppDir 'C:\ProgramData\Catalogador\python_api' -Port 8000
